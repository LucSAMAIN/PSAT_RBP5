...
# -------------------------------
# YOLO Model setup using ultralytics
# -------------------------------
# 🔸 Change this to your model path or use a model name (e.g., 'yolov8n.pt')
pt_path = "yolo11n.pt" # yolov11 models are still compatible
